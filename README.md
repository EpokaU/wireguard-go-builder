[![Build and Release](https://github.com/EpokaU/wireguard-go-builder/actions/workflows/build_and_release.yml/badge.svg)](https://github.com/EpokaU/wireguard-go-builder/actions/workflows/build_and_release.yml)
